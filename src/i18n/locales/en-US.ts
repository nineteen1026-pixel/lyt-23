export default {
  dishes: {
    'tomato-egg': {
      ...
      description: 'Classic home-style dish, sweet and sour, perfect with rice',
      ingredients: {
        '番茄': 'Tomato',
        '鸡蛋': 'Egg',
      },
    ...
    'miso-salmon': {
      ...
      description: 'Japanese style, crispy outside tender inside, rich in omega-3',
      ingredients: {
        '三文鱼': 'Salmon',
        '味噌': 'Miso',
      },
    ...
    'veggie-pasta': {
      ...
      description: 'Fresh and healthy, colorful and comforting meal',
      ingredients: {
        '意面': 'Pasta',
        '西兰花': 'Broccoli',
        '小番茄': 'Cherry Tomato',
    ...
    'teriyaki-chicken': {
      ...
      description: 'Juicy chicken thighs coated in rich teriyaki sauce',
      ingredients: {
        '鸡腿': 'Chicken Thigh',
        '酱油': 'Soy Sauce',
      },
    ...
    'mushroom-soup': {
      ...
      description: 'Rich and silky, comforting soup for tired days',
      ingredients: {
        '蘑菇': 'Mushroom',
        '奶油': 'Cream',
      },
    ...
    'avocado-toast': {
      name: 'Avocado Toast',
      description: 'Quick brunch, healthy and Instagram-worthy',
      ingredients: {
        '吐司': 'Toast',
        '牛油果': 'Avocado',
        '鸡蛋': 'Egg',
    ...
    'spring-roll': {
      ...
      description: 'Bright spring days, bite into crispy spring rolls',
      ingredients: {
    ...
    'strawberry-dessert': {
      ...
      description: 'Sweet little joy of strawberry season',
      ingredients: {
        '草莓': 'Strawberry',
        '牛奶': 'Milk',
        '淡奶油': 'Heavy Cream',
    ...
    'mung-bean-soup': {
      name: 'Mung Bean Soup',
      description: 'Cooling summer treat, a bowl of mung bean soup beats the heat',
      ingredients: {
        '绿豆': 'Mung Bean',
        '冰糖': 'Rock Sugar',
      },
    ...
    'cold-noodles': {
      name: 'Spicy and Sour Cold Noodles',
      description: 'Tangy and spicy cold noodles for summer',
      ingredients: {
        '面条': 'Noodles',
        '黄瓜': 'Cucumber',
        '花生碎': 'Crushed Peanuts',
    ...
    'mooncake': {
      ...
      description: 'Full moon brings reunion, mooncakes are essential',
      ingredients: {
        '月饼皮': 'Mooncake Pastry',
        '莲蓉': 'Lotus Paste',
        '咸蛋黄': 'Salted Egg Yolk',
    ...
    'osmanthus-cake': {
      name: 'Osmanthus Cake',
      description: 'The taste of autumn in osmanthus fragrance',
      ingredients: {
    ...
    'hot-pot': {
      name: 'Home Style Hot Pot',
      description: 'Cold wind blows, gather around the hot pot',
      ingredients: {
        '肥牛卷': 'Beef Slices',
        '白菜': 'Napa Cabbage',
        '豆腐': 'Tofu',
    ...
    'tangyuan': {
      name: 'Sesame Tangyuan',
      description: 'Sweet rice dumplings for family reunion',
      ingredients: {
        '糯米粉': 'Glutinous Rice Flour',
        '黑芝麻': 'Black Sesame',
        '猪油': 'Lard',
    ...
    'laba-porridge': {
      name: 'Laba Congee',
      description: 'Warm congee for Laba Festival',
      ingredients: {
        '大米': 'Rice',
        '红豆': 'Red Bean',
        '花生': 'Peanut',
    ...
    'rice-cake': {
      ...
      description: 'Rice cake symbolizes rising prosperity',
      ingredients: {
        '糯米粉': 'Glutinous Rice Flour',
        '红糖': 'Brown Sugar',
        '红枣': 'Red Date',
  ...
  steps: {
    wash: {
      title: 'Wash Ingredients',
      subtitle: "Let's wash the {dishName} together!",
      startButton: '💧 Wash!',
      washingButton: 'Washing...',
      completeButton: '✓ Done!',
      progressLabel: 'Washing Progress',
      clickHint: '👆 Tap ingredients or button to start washing',
      completeMessage: 'All clean! ✨',
    },
    cut: {
      title: 'Cutting Station',
      subtitle: 'Tap button to cut ingredients~',
      startButton: 'Start Cutting',
      cutButton: 'Cut #{cutNumber}',
      nextButton: 'Next',
      progressLabel: 'Cutting Progress',
      completeMessage: 'All cut! 🔪✨',
    },
    season: {
      title: 'Seasoning Station',
      subtitle: 'Tap bottles to add delicious seasonings~',
      mixButton: 'Mix Well!',
      mixingButton: 'Mixing...',
      waitButton: 'Please add all seasonings first',
      progressLabel: 'Seasoning Progress',
      completeMessage: 'Seasoning Complete 🧂✨',
      skipped: 'Skipped',
      normalDosage: 'Normal',
      recommended: 'Recommended: {dosage}',
      skippedWithReason: 'Skipped ({dosage})',
    },
    bake: {
      title: 'Oven Baking',
      subtitle: 'Put ingredients in oven, wait for deliciousness~',
      insertButton: 'Put in Oven',
      bakingButton: 'Baking...',
      doneButton: 'Take Out! 🍽️',
      progressLabel: 'Baking Progress',
      temperatureLabel: 'Oven Temperature',
      linkTimer: '⏱️ Link to Kitchen Timer',
      timerLinked: 'Linked to Kitchen Timer',
      hint: '👇 Tap button below to put in',
    },
    plate: {
      title: 'Plating',
      subtitle: 'Careful plating makes food more special',
      progressLabel: 'Plating Progress',
    },
    progress: {
      wash: 'Wash',
      cut: 'Cut',
  ...
  feedback: {
    title: 'Feedback',
    subtitle: 'Your voice makes our kitchen better',
    form: {
      title: 'Submit Feedback',
      rating: 'Experience Rating',
      ratingRequired: 'Experience Rating (Required)',
      ratingHint: 'Click stars to rate your experience',
      ratingLabels: {
        '1': 'Very Unsatisfied 😞',
        '2': 'Not Great 😕',
        '3': 'Just Okay 🙂',
      ...
      contentRequired: 'Your Suggestion (Required)',
      contentPlaceholder: 'Share your thoughts and ideas to help us improve~',
      submit: 'Submit Feedback',
      submitSuccess: 'Thanks for your feedback! Saved to local queue',
    },
    queue: {
      ...
      exportSuccessJson: 'JSON file exported',
      exportSuccessCsv: 'CSV file exported',
      clearAll: 'Clear All',
      clearConfirm: 'Clear all feedback?',
      clearSuccess: 'All feedback cleared',
      confirm: 'Confirm',
      cancel: 'Cancel',
  ...
  backup: {
    ...
    overview: {
      ...
      cookingRecords: 'Cooking Records',
      notes: 'Notes',
      badges: 'Badges',
      favorites: 'Favorites',
      totalRecords: 'Total Exportable Records',
      records: 'records',
    },
    export: {
      title: 'Export Backup',
      description: 'Export your cooking records, check-in data, unlock status, etc. as a JSON file for backup or migration to other devices.',
      button: 'Start Export',
      selectScope: 'Select Export Scope',
      download: 'Download JSON File',
      copy: 'Copy to Clipboard',
      copied: 'Copied',
      scope: {
        all: 'All Data',
        cooking: 'Check-ins & Cooking Records',
    ...
    import: {
      ...
      description: 'Restore your data from a backup file. Supports overwriting existing data or merging imports.',
      selectFile: 'Click or drag to select JSON backup file',
      supportFormat: 'Supports .json format',
      validate: 'Validate File First',
      validateSuccess: 'Validation Passed',
      validateFailed: 'Validation Failed',
      selectMode: 'Select Import Mode',
      overwrite: 'Overwrite Import',
      overwriteDesc: 'Clear all current data and completely replace with data from backup file',
      merge: 'Merge Import',
      mergeDesc: 'Merge backup data with existing data, duplicates will be skipped',
      button: 'Start Import',
      success: 'Import Successful',
      failed: 'Import Failed',
      imported: '{n} records imported',
      confirmOverwriteTitle: 'Confirm Overwrite Import?',
      confirmOverwriteDesc: 'This action will clear all current data and replace it with the backup file content. This cannot be undone.',
      confirmMergeTitle: 'Confirm Merge Import?',
      confirmMergeDesc: 'This action will merge backup data with your current data. Duplicate records will be skipped automatically.',
      confirm: 'Confirm Import',
      cancel: 'Cancel',
    },
    tips: {
      title: 'Tips',
      tip1: 'Backup file contains all your check-in records, cooking notes, unlock status, and personal settings',
      tip2: 'It is recommended to export backups regularly to prevent data loss due to browser cache cleanup',
      tip3: 'It is recommended to export current data as a backup before importing',
      tip4: 'All data is stored locally in your browser and will not be uploaded to any server',
    },
  },
  tutorial: {
